                ...
                <div class="col s12">
                    <div class="card blue-grey z-depth-4 darken-1 ">
                        <div class="card-content white blue-grey-text robotoGrueso">
                            <span class="card-title">Nombre: <%out.print(rs.getString(2));%> <%out.print(rs.getString(3));%> <%out.print(rs.getString(4));%> <br> ID: <%out.print(rs.getString(1));%></span>
                            <br>
                            <section class="row">
                                ...
                                <div class="col s12 m6">
                                    <div class="card blue-grey lighten-4">
                                        <div class="card-content blue-grey-text">
                                            <span class="card-title">Alias</span>
                        ...
                        <div class="card-action blue-grey lighten-3">
                            <a href="despliegueUsuarios.jsp" class="waves-effect teal btn-large darken-2 waves-light btn-small"><i class="material-icons left">playlist_add_check</i>Listado de usuarios.</a>
