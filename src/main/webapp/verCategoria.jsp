                ...
                <div class="col s12">
                    <div class="card blue-grey z-depth-4 darken-1 ">
                        <div class="card-content white blue-grey-text robotoGrueso">
                            <span class="card-title"><%out.print(rs.getString(2));%> &nbsp;&nbsp;&nbsp; ID: <%out.print(rs.getString(1));%></span>
                            <p class="robotoNormal"><b>Descripción:&nbsp;&nbsp;&nbsp; </b> <%out.print(rs.getString(3));%></p>
                        </div>
                        <div class="card-action blue-grey lighten-3">
                            <a href="despliegueCategorias.jsp" class="waves-effect teal btn-large darken-2 waves-light btn-small"><i class="material-icons left">playlist_add_check</i>Listado de categorias.</a>
