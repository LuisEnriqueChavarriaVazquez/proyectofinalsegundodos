...
<html lang="en">
    ...
    <body class="blue-grey darken-2">
        ...
        <nav>
            <div class="nav-wrapper blue-grey darken-4">
                <ul id="nav-mobile" class="right">
                    ...
                    <li><a href="addCategoria.jsp" class="waves-effect waves-light btn"><i class="material-icons left">add</i>Agregar categorias.</a></li>
                </ul>
            </div>
        </nav>
        ...
        <section class="container">
            <br><br>
            <h3 class="white-text">Despliegue de categorias (para edición).</h3>
            <br>
            <table class="striped centered responsive-table blue-grey lighten-3 z-depth-4" style="border-radius: 20px;">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="columnasDespliegue"><b>
                                <a  href="verCategoria.jsp?cod=<%out.print(rs.getString(1));%>"
                        ...
                        <td class="centeredOptions">
                            <a href="editCategoriaForm.jsp?cod=<%out.print(rs.getString(1));%>" class="waves-effect waves-light btn btnOptions blue-grey darken-3 topButton"><i class="material-icons left">edit</i></a>
                ...
                <div id="modal<%out.print(rs.getString(1));%>" class="modal">
                    <div class="modal-content">
                        ...
                        <p>¿En verdad desea eliminar la categoria <b><%out.print(rs.getString(2));%></b>?</p>
                    </div>
                    <div class="modal-footer">
                        <a href="eliminarCategorias.jsp?cod=<%out.print(rs.getString(1));%>" class="modal-close waves-effect waves-green btn green darken-3"><i class="material-icons left">done</i>Agree</a>
                    </div>
                </div>
